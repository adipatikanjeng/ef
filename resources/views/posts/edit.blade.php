    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($post->image)
                        <a href="{{ asset('uploads/'.$post->image) }}" target="_blank"><img src="{{ asset('uploads/thumb/'.$post->image) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('content', old('content'), ['class' => 'form-control editor', 'placeholder' => '', 'required' => true]) !!}
                    <p class="help-block"></p>
