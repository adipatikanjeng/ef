<meta charset="utf-8">
<title>
      @if(@$pageTitle) {{ $pageTitle.' | '.trans('global.global_title') }} @else {{ trans('global.global_title') }} @endif
</title>
...
<link href="{{ url('adminlte/plugins/sidebar-nav/dist/sidebar-nav.min.css') }}" rel="stylesheet">
...
<link href="{{ url('adminlte/css/animate.css') }}" rel="stylesheet">
<link href="{{ url('css/style.css') }}" rel="stylesheet">
<link rel="stylesheet" href="//cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css" />
<link href="{{ url('adminlte/css/style.css') }}" rel="stylesheet">
<link href="{{ url('adminlte/css/colors/default.css') }}" rel="stylesheet">
<link href="{{ url('adminlte/plugins/MaterialDesign-Webfont-master/css/materialdesignicons.min.css') }}" rel="stylesheet">
