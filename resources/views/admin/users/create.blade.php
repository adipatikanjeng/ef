        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('role[]', $roles, old('role'), ['class' => 'form-control select2', 'required' => '', 'id' => 'selectRole']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('role'))
                        <p class="help-block">
                            {{ $errors->first('role') }}
            ...
            <div class="row course">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('course_id[]', $courses, old('course_id'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row student-only" hidden >
                <div class="col-xs-12 form-group">
